...
HOSTCXX      = $(CCACHE) g++
HOSTCFLAGS   := -Wall -Wmissing-prototypes -Wstrict-prototypes -Wno-error=address-of-packed-member -Wno-error=stringop-overread -O1 -fomit-frame-pointer -std=gnu99 
HOSTCXXFLAGS = -O1
